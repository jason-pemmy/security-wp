    ...
    $.fn.slides = function (option) {
        ...
        return this.each(function () {
            ...
            if (option.generateNextPrev) {
                $('.' + option.container, elem).after('<div class ="slider_nav_container"><a href="#" class="' + option.prev + '">Prev</a>');
                $('.' + option.prev, elem).after('<a href="#" class="' + option.next + '">Next</a></div>');
            }
                ...
                if (!active && loaded) {
                    ...
                    if (effect === 'fade') {
                        ...
                        if (option.autoHeight) {
                            ...
                            control.children(':eq(' + prev + ')').css('z-index',-1)

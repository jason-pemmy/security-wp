...
function VelvetBluesUU_options_page(){
		...
		'options' =>			array("UPDATE $wpdb->options SET option_value = replace(option_value, '".$oldurl."','".$newurl."')",  __('Options','velvet-blues-update-urls') ),
...
<input name="VBUU_update_links[]" type="checkbox" id="VBUU_update_true" value="options" /> <label for="VBUU_update_true"><strong><?php _e('URLs in options table','velvet-blues-update-urls'); ?></strong></label><br/>
